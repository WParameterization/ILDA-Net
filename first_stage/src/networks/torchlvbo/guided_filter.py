...
class ConvGuidedFilter(nn.Module):
    def __init__(self, radius=1):
        ...
        self.conv_a = nn.Sequential(nn.Conv2d(6, 32, kernel_size=1, bias=False), nn.ReLU(inplace=True),  nn.Conv2d(32, 32, kernel_size=1, bias=False), nn.ReLU(inplace=True),nn.Conv2d(32, 3, kernel_size=1, bias=False))
